    ...
    <form onSubmit={handlePush}>
      <div className="relative ">
        ...
        <input
          ...
          className=" w-full  border-2 block bg-inherit border-gray-300 rounded-full py-[8px] pl-10  outline-2
        ...
        />
        <MagnifyingGlassIcon className="pointer-events-none  absolute left-3 top-1/2 h-[20px] w-[20px] -translate-y-1/2 text-black peer-focus:text-gray-400" />
      </div>
    </form>
  );
};
