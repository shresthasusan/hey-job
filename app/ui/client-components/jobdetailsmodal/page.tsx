    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div  className="bg-white border rounded-2xl p-10  shadow-lg w-full max-w-5xl max-h-5xl overflow-y-auto">
                ...
                <button
                        className="px-4 py-2 justi bg-gray-400 text-white rounded-full hover:bg-gray-600"
                        onClick={onClose}
                    >
                        Edit
                    </button>
                    ...
                    <button
                        className="px-4 py-2 justi bg-red-400 text-white rounded-full hover:bg-red-600"
                        onClick={onClose}
                    >
                        Close
                    </button>
