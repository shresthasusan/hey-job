      ...
      <div className="bg-white rounded-2xl p-8 w-full max-w-4xl flex flex-col">
        ...
        {clientData && (
          <div className="border-t pt-6 mt-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-gray-700">
              <p><span className="font-semibold">Full Name:</span> {clientData?.fullName || "Not provided"}</p>
              <p><span className="font-semibold">Company:</span> {clientData?.isCompany ? "Yes" : "No"}</p>
              <p><span className="font-semibold">Industry:</span> {clientData?.industry?.join(", ") || "Not provided"}</p>
              <p><span className="font-semibold">Company Size:</span> {clientData?.companySize || "Not provided"}</p>
              <p><span className="font-semibold">Average Budget:</span> ${clientData?.averageBudget || "Not provided"}</p>
              <p><span className="font-semibold">Preferred Skills:</span> {clientData?.preferredSkills?.join(", ") || "Not provided"}</p>
              <p><span className="font-semibold">Location:</span> {clientData?.location || "Not provided"}</p>
              <p><span className="font-semibold">Rating:</span> {clientData?.rating ?? "Not rated yet"}</p>
            </div>
          </div>
        )}
      </div>
