...
>>>>>>> 2bef623515deb0b5cdf60a4498de3e7b96d8efdb
            ...
            <div className="flex-1 pt-4 md:pt-0">
              ...
              {freelancerData && (
                <div className="flex flex-wrap gap-2 mt-3">
                  {freelancerData.skills?.slice(0, 3).map((skill: string, i: number) => (
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="px-6 py-4 border-b">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Skills & Industries</h2>
              </div>
            </div>
            <div className="p-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {freelancerData?.industries?.length > 0 ? (
                      freelancerData.industries.map((industry: string, i: number) => (
                  ...
                  {freelancerData.workExperience.map((work: any, index: number) => (
                    <div key={index} className={index > 0 ? "pt-6 border-t" : ""}>
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                        <h3 className="font-semibold text-lg text-gray-800">{work.jobTitle || work.position}</h3>
                        <span className="mt-1 md:mt-0 px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full">
                          {work.startDate && work.endDate ? `${work.startDate} to ${work.endDate}` : work.duration}
                        </span>
                      </div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="px-6 py-4 border-b">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Project Portfolio</h2>
              </div>
            </div>
            <div className="p-6">
                    ...
                    <div key={index} className="bg-white border rounded-lg overflow-hidden shadow-sm">
                      ...
                      <div className="p-4">
                        ...
                        {project.portfolioFiles && (
                          <button
                            onClick={() => setSelectedAttachment(project.portfolioFiles)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-4 border-b flex justify-between items-center">
              ...
              <button onClick={closeAttachmentModal} className="text-gray-500 hover:text-gray-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
            ...
            <div className="flex-1 overflow-auto p-4">
              {typeof selectedAttachment === "string" && selectedAttachment.endsWith(".pdf") ? (
                <iframe src={selectedAttachment} className="w-full h-full min-h-[500px]" title="PDF Viewer"></iframe>
              ) : typeof selectedAttachment === "string" && selectedAttachment.match(/\.(jpeg|jpg|gif|png)$/i) ? (
                <img
